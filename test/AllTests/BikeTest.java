...
public abstract class BikeTest {
	...
	public void isEquipedTest() {
		assertFalse(this.bike.isEquipped(Equipment.BASKET));
		assertFalse(this.bike.isEquipped(Equipment.LUGGAGE_RACK));
		this.bike.addEquipment(Equipment.BASKET);
		assertTrue(this.bike.isEquipped(Equipment.BASKET));
		assertFalse(this.bike.isEquipped(Equipment.LUGGAGE_RACK));
	}
